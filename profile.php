...
$user_email = $_SESSION['uemail']; // Assuming you store email in session
$get_id_query = "SELECT uid FROM user WHERE uemail = ?";
$stmt = mysqli_prepare($con, $get_id_query);
mysqli_stmt_bind_param($stmt, "s", $user_email);
mysqli_stmt_execute($stmt);
$id_result = mysqli_stmt_get_result($stmt);
$id_row = mysqli_fetch_assoc($id_result);
$user_id = $id_row['uid']; // This is their referral code!
            ...
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5 bg-white">
                    ...
                    <div class="referral-section">
                        <h5 class="text-secondary border-bottom-on-white pb-3 mb-4">Your Referral</h5>
                        <p>
                            Invite your friends to register at HomeHub! Use my code:
                            <strong class="referral-code"><?php echo $user_id; ?></strong> for benefits.
                        </p>
                        <button id="copy-referral-code" type='button'class="btn btn-sm btn-primary">Copy Code</button>
                        <p id="copy-message" style="display:none; color: green;">Code Copied!</p>
                    </div>
                </div>
                    ...
                    ?>
                        <!-- <div class="user-info mt-md-50">
                            ...
                            <div class="font-18">
                                ...
                                <div class="mb-1 text-capitalize"><b>User Id:</b> <?php echo $row['0']; ?></div>
                            </div>
                        </div> -->
                    <?php } ?>
                        <div class="row">
