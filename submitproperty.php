...
// Code to insert a new property
$error = "";
$msg = "";
if(isset($_POST['add'])) {
    $title = $_POST['title'];
    $content = mysqli_real_escape_string($con, $_POST['content']); // Escaping special characters
    $ptype = $_POST['ptype'];
    $bhk = $_POST['bhk'];
    $bed = $_POST['bed'];
    $balc = $_POST['balc'];
    ...
    $status = $_POST['status'];
    $uid = $_SESSION['uid'];
    $feature = mysqli_real_escape_string($con, $_POST['feature']); // Escaping special characters
    ...
    // Temporary names for uploaded files
    ...
    // Move uploaded files to their respective locations
    ...
    if($result) {
        ...
        $error = "<p class='alert alert-danger'>Error Inserting Property: " . mysqli_error($con) . "</p>";
    }
}
?>
<!DOCTYPE html>
