...
<!-- <script src="//code.tidio.co/xds4gfinwtm6bdodrgrmf9xmxxozqtpd.js" async></script> -->
<!-- <script>(function(w, d) { w.CollectId = "670705b5f4bc76248fc4f2a0"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://collectcdn.com/launcher.js"); h.appendChild(s); })(window, document);</script> -->
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/new.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
        <!-- <div class="overlay-black w-100 slider-banner1 position-relative"  >
            <img src="images/banner/new.jpg" style="filter: blur(3px);">
        <div> -->
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control rounded-select" name="type">
                                        ...
                                        <!-- <style>
                                            .rounded-select {
                                                ...
                                                border: 1px solid #ccc; /* Optional: border color and style */
                                            }

                                            .rounded-select:focus {
                                                outline: none; /* Remove default focus outline */
                                                border-color: #007bff; /* Change border color on focus, optional */
                                                box-shadow: 0 0 5px rgba(0, 123, 255, 0.5); /* Add subtle shadow on focus, optional */
                                            }
                                        </style> -->
                                    </div>
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="stype" border-radius="30px">
                                    ...
                                    <div class="col-md-4 col-lg-2">
                                        <div class="form-group">
                                            <button type="submit" name="filter" class="btn btn-success w-100 border-radius-30">Search Property</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage" height="180px">
