<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        <div class="footer-logo mb-4"> <a href="#"><img class="logo-bottom" src="images/logo/brand.png" alt="image"></a> </div>
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget footer-nav mb-4">
                                                ...
                                                <ul class="hover-text-primary">
                                                    ...
                                                    <li><a href="designer.php" class="text-white">Our interior_designers</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-lg-4">
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Real Estate Website - Developed By  </span> </div>
                    <div class="col-sm-6">
        ...
        <script src="//code.tidio.co/xds4gfinwtm6bdodrgrmf9xmxxozqtpd.js" defer></script>